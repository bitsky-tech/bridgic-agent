 ...
 *  - Opening still goes through `requestFileOpenAtom`: .xlsx enters the Session Excel workbench, while other files use the
 *    remembered OS-open confirmation policy. No separate path is started here.
 */
