/**
 * Resolves `file://` links in markdown prose into local file targets that can be handed to openPath.
 *
 ...
 * requestFileOpenAtom (openPath + confirmation dialog + remembering + failure toast).
 */
