...
export const IPC = {
  ...
  wordHost: {
    ...
    openDocument: 'word-host:openDocument',
    ...
    requestClose: 'word-host:requestClose',
  ...
  events: {
    ...
    excelHostCloseRequested: 'excel-host-close-requested',
    ...
    wordHostCloseRequested: 'word-host-close-requested',
