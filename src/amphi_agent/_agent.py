...
from .cognitive.build.state import BuildStageState
from .cognitive.normal.state import NormalStageState
from .cognitive.presentation.state import PresentationStageState
from .cognitive.workflow.state import WorkflowStageState
from .security import ExecutionMode, Permission
from .security._audit import append_decisions, write_approval_record
from .security._routing import append_user_decisions
...
from ..amphi_service.i18n import activate_locale, detect_locale
...
class AmphiAgent(AmphibiousAutoma[AmphiOTAContext, AmphiContext]):
    ...
    async def init_state(self, ota_context: AmphiOTAContext, context: AmphiContext) -> None:
        ...
        """
        detected = detect_locale(*BaseThink._recent_user_messages(ota_context, context))
    ...
    async def _resume_permission(self, ota_context: AmphiOTAContext, context: AmphiContext, permission: Dict[str, Any], rounds: List[Any], original_user_input: Any) -> None:
        ...
        append_user_decisions(BaseThink._permission_dir(context, permission), decided_items)
