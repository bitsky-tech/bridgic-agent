...
- Presentation making: call `request_presentation` when the user explicitly asks to create or substantially rebuild a PowerPoint presentation. The dedicated pipeline owns the brief, evidence and visual plan, live composition, and final review. Keep small local slide edits in Main.
